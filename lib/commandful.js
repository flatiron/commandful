/*
 * commandful.js: creates socket.io event maps to resourceful
 *
...
var log = exports.log = function () {
  ...
  console.log('info: '.green + args.join(' '))
};
...
var CommandfulRouter = exports.CommandfulRouter = function (resource, options) {
  options = options || {};
  ...
  //
  log(welcome.message().join('\n'));
  
  //
  // Display help
  //
  log('currently available commands')
